        ...
        {isMenuOpen && (
          <nav className="md:hidden mt-4 pb-4 border-t border-gray-100 pt-4">
            <div className="flex flex-col space-y-3">
              <button 
                onClick={() => scrollToSection('sobre')}
                className="text-left text-gray-700 hover:text-therapy-blue-dark transition-colors py-2"
              >
                Sobre
              </button>
              <button 
              ...
              <button 
                onClick={() => scrollToSection('contato')}
                className="bg-therapy-blue-dark text-white px-6 py-3 rounded-full hover:bg-blue-700 transition-colors text-center"
              >
                Agendar Sessão
              </button>
            </div>
